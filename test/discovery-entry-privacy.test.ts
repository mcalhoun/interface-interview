...
import { discoveredSecrets } from "@cua/agent"
import { discover } from "../packages/agent/src/loop.ts"
import { compileArtifact, serializeCompilation } from "../packages/agent/src/compile.ts"
...
import { runDiscovery, shippedPolicy } from "./support/private-discovery-harness.ts"
