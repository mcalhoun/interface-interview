EVIDENCE FOR RUN scripted-model-no-llm-drove-this
====================================================
...
point where evidence is serialised. This run declared no sensitive parameters.
...
Sensitivity policy: every discovered parameter is sensitive (ADR-0008).
