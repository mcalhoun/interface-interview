 ...
 *
 *     bun run apps/demo/src/support/drive-the-assisted-rung.ts
 *
...
const program = Effect.gen(function* () {
  ...
  writeFileSync(
    ...
    [
      ...
      "  * the shipped config/policies/default.yaml, including the assist: block that",
      ...
      "      config/capabilities/ — promoting a proposal into a capability still takes a person.",
      "",
