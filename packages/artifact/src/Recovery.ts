 ...
 * Action is repeatable — and nothing about a document can establish that on its
 * own. So `repeatable` below is required of any `at-step` rule in a Capability
 * whose Actions include a risky one, and the check that enforces it lives in the
