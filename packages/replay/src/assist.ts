 ...
 *
 * Anything already learned to need authority is excluded. Today
 * `classificationOf` can only answer `business_outcome`, so the filter removes
 * nothing; when `requiresHuman:` exists it removes those codes here, and no
 * other line changes.
 */
/**
